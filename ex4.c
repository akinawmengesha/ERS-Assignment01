...
#define LED_ORANGE 1
#define LED_RED    2
#define LED_ORANGE_AGAIN 3  // Orange appears again in the sequence

uint8_t currentLed = LED_GREEN;  // Start with the green LED
/* USER CODE END PV */
  ...
  while (1)
  {
    ...
    switch (currentLed)
    {
      ...
      case LED_RED:
        ...
        break;
      case LED_ORANGE_AGAIN:
        HAL_GPIO_WritePin(LD3_GPIO_Port, LD3_Pin, GPIO_PIN_SET);  // Orange ON again
        break;
    }
    ...
    currentLed = (currentLed + 1) % 4;  // Cycle through 0, 1, 2, 3
  }
  /* USER CODE END 3 */
}
